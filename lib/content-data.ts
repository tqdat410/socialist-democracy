...
export const sectionIllustrationSlots: SectionIllustrationSlot[] = [
  {
    ...
    section: "2",
    block: "hero",
    src: buildCloudinaryUrl(cloudinaryAssets.section1Evolution05),
  ...
  },
  {
    ...
    src: buildCloudinaryUrl(cloudinaryAssets.section2Pari),
  ...
  },
  {
    ...
    src: buildCloudinaryUrl(cloudinaryAssets.section2Cmt10),
  ...
  },
  {
    ...
    src: buildCloudinaryUrl(cloudinaryAssets.section2Development),
  ...
  },
  {
    ...
    src: buildCloudinaryUrl(cloudinaryAssets.section2Political),
  ...
  },
  {
    ...
    src: buildCloudinaryUrl(cloudinaryAssets.section2Economic),
  ...
  },
  {
    ...
    src: buildCloudinaryUrl(cloudinaryAssets.section2Cultural),
  ...
  },
  {
    ...
    block: "hero-xhcn",
    src: buildCloudinaryUrl(cloudinaryAssets.section1Evolution05),
    alt: "Minh họa đại diện dân chủ xã hội chủ nghĩa",
    caption: "xã hội chủ nghĩa",
    placeholderText: "MINH HỌA: DÂN CHỦ XHCN",
    hasRealAsset: true,
  },
  {
    id: "s3-hero-ts",
    section: "3",
    block: "hero-ts",
    src: buildCloudinaryUrl(cloudinaryAssets.section1Evolution04),
    alt: "Minh họa đại diện dân chủ tư sản",
    caption: "tư sản",
    placeholderText: "MINH HỌA: DÂN CHỦ TƯ SẢN",
    hasRealAsset: true,
  },
  {
    id: "s3-hero",
  ...
  },
  {
    ...
    src: buildCloudinaryUrl(cloudinaryAssets.section3Example2),
  ...
  },
  {
    ...
    section: "3",
    block: "example-labor",
    src: buildCloudinaryUrl(cloudinaryAssets.section3Example3),
